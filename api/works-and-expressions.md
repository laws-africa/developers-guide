...
{% swagger baseUrl="https://api.laws.africa" path="/v2/akn/:country/.:format" method="get" summary="List works for a place" %}
{% swagger-description %}
This endpoint lists works for a country or locality.
{% endswagger-description %}

{% swagger-parameter in="path" name="country" type="string" %}
...
{% swagger-parameter in="query" name="updated_at__lte" type="iso8601" %}
Only include expressions updated at or before the given timestamp. The timestamp must be an iso8601 timestamp.
{% endswagger-parameter %}

{% swagger-parameter in="query" name="updated_at__gte" type="iso8601" %}
Only include expressions updated at or after the given timestamp. The timestamp must be an iso8601 timestamp.
{% endswagger-parameter %}

{% swagger-parameter in="query" name="created_at__lte" type="iso8601" %}
Only include expressions create at or before the given timestamp. The timestamp must be an iso8601 timestamp.
{% endswagger-parameter %}

{% swagger-parameter in="query" name="created_at__gte" type="iso8601" %}
Only include expressions created at or after the given timestamp. The timestamp must be an iso8601 timestamp.
{% endswagger-parameter %}

{% swagger-response status="200" description="Paginated list of works in JSON format." %}
```javascript
{
  "count": 1,
  "next": null,
...
{% swagger baseUrl="https://api.laws.africa" path="/v2/:frbr-uri.:format" method="get" summary="A single expression" %}
{% swagger-description %}
...
{% swagger-parameter in="query" name="standalone" type="number" %}
...
{% swagger-response status="200" description="A single work expression in JSON format." %}
```javascript
{
  "url": "https://api.laws.africa/v2/akn/za-wc033/act/by-law/2005/beaches/eng@2005-10-03",
  "title": "By-Law relating to Beaches",
