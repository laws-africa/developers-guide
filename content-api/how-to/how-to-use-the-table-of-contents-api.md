...
This guide will take you through how to use the Table of Contents (TOC) API, part of [Laws.Africa's Content API](../README.md). After reading this guide you will know:
...
[Table of Contents API reference](../reference/table-of-contents.md)
